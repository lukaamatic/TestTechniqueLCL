...
var flow_path = 'C:/Users/L/PycharmProjects/testTechniqueLCL/rpa';
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://www.insee.fr/fr/information/4769950'}); sleep(1000);
techo('https://www.insee.fr/fr/information/4769950' + ' - ' + chrome.getTitle());});

casper.then(function() {{techo('click //*[@id="consulter"]/div/div[4]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[4]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[4]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[4]/a').exit();});}});

casper.then(function() {{techo('click //*[@id="consulter"]/div/div[5]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[5]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[5]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[5]/a').exit();});}});

casper.then(function() {{techo('click //*[@id="consulter"]/div/div[6]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[6]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[6]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[6]/a').exit();});}});

casper.then(function() {{techo('click //*[@id="consulter"]/div/div[7]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[7]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[7]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[7]/a').exit();});}});

casper.then(function() {{techo('click //*[@id="consulter"]/div/div[8]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[8]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[8]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[8]/a').exit();});}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://www.insee.fr/fr/information/4190491'}); sleep(1000);
techo('https://www.insee.fr/fr/information/4190491' + ' - ' + chrome.getTitle());});
...
casper.then(function() {{techo('click //*[@id="consulter"]/div/div[9]/a');
casper.waitFor(function check() {return check_tx('//*[@id="consulter"]/div/div[9]/a');},
function then() {chrome.click(tx('//*[@id="consulter"]/div/div[9]/a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="consulter"]/div/div[9]/a').exit();});}});

// Wait 15 seconds to give the download time to complete on slow networks
casper.then(function() {techo('wait 600');});
casper.then(function() {casper.wait(600000, function() {});});
